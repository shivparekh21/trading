...
public class CoinController {
    ...
    public ResponseEntity<JsonNode> searchCoin(@RequestParam("search") String search) throws Exception {
    ...
    @GetMapping("/trading")
    public ResponseEntity<JsonNode> getTrading() throws Exception {
